...
@section('content')
		...
		<div class="row">
			<div class="col-md-12">				
			<form action="/dtr/excel_post" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				{{ csrf_field() }}
				<input type="file" name="xls" required><br>
				<input type="submit" class="btn green btn-sm" value="Upload">
			</form>
