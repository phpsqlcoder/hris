		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="alert alert-warning alert-dismissable">
					...
					<strong>Warning!</strong> This feature will delete both DTR and Payroll Data.
				</div>				
				<ul class="page-breadcrumb breadcrumb">					
					...
					<li>
						<a href="#" class="btn blue" style="position:relative;top:-4px;color:white;" onclick="submitfilter($('#location').val(),$('#contractor').val(),$('#cutoff').val());">
						Delete <i class="fa fa-arrow-circle-o-right"></i></a>
					</li>					
				</ul>
