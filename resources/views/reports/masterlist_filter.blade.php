			...
			<div class="col-md-12">
				...
				<ul class="page-breadcrumb breadcrumb">					
					<li>
						...
						<a href="/">Active as of  {{date('F d Y')}}</a>
						<i class="fa fa-angle-right"></i>						
					</li>
					
					<li>
						<a href="#" class="btn blue" style="position:relative;top:-4px;color:white;" onclick="window.open('/reports/masterlist/'+$('#cutoff').val(),'','width=1200,height=900');">
