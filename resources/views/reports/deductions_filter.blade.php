		...
		<div class="row">
			<div class="col-md-12">
				...
				<ul class="page-breadcrumb breadcrumb">					
					...
					<li>
						<a href="#" class="btn blue" style="position:relative;top:-4px;color:white;" onclick="window.open('/reports/deductions/'+$('#cutoff').val()+'|'+$('#teamleader').val()+'|'+$('#location').val(),'','width=1200,height=900');">
